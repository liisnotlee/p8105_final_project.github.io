...
p4 = ggplot(symptoms_long, 
  ...
  geom_smooth(method = "lm", se = TRUE, linewidth = 2.0, alpha = 0.2) +
...
* **Bloating**: Considerable downward trend suggests higher activity associates with reduced bloating
* **Fatigue**: Considerable downward trend suggests higher activity associates with reduced fatigue
* **Food cravings**: Considerable downward trend suggests higher activity associates with fewer food cravings
* **Head aches**: Slight downward trend suggests higher activity associates with fewer headaches
* **Indigestion**: Considerable downward trend suggests higher activity associates with lower indigestion

**Flat relationships (no clear association):**
* **Appetite, headaches, sleep issues, sore breasts**: Essentially flat line
* **Cramps**: Near-horizontal line despite often being referred as one of the primary symptoms of menstruation
* **Mood swings**: Nearly flat line
