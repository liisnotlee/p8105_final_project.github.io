...
### `demographic_data` - simplified demographic data only for table summary
```{r}
demographic_data = subject_info_raw %>%
  mutate(
    ...
    gender = case_when(
      ...
      gender == "Woman" ~ "Woman"),
      gender = factor(gender, levels = c("Woman", "Gender Fluid or Non-binary", "Prefer not to say or Other")), 
...
### Summary Table 
```{r}
#This is setup to make a clean table with simplified variables and percent count
#Age
