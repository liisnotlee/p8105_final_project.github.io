...
```{r, include = FALSE}
education_health_lit = subject_info %>%
  filter(!is.na(education_abrv),
    !is.na(self_report_menstrual_health_literacy)) %>%
  ggplot(aes(x = education_abrv, fill = self_report_menstrual_health_literacy)) +
...
fatigue_model = lmer( 
  fatigue_score ~ total_active_min + sleep_score + stress_score + factor(education_abrv, ordered = FALSE) + race_category + bmi + age + lh + estrogen + (1 | id), data = merged_df_model, REML = FALSE)
...
cramps_model = lmer( 
  cramps_score ~ total_active_min + sleep_score + stress_score + factor(education_abrv, ordered = FALSE) + race_category + bmi + age + lh + estrogen + (1 | id), data = merged_df_model, REML = FALSE)
...
bloating_model = lmer( 
  bloating_score ~ total_active_min + sleep_score + stress_score + factor(education_abrv, ordered = FALSE) + race_category + bmi + age + lh + estrogen + (1 | id), data = merged_df_model, REML = FALSE)
...
sleepissues_model = lmer( 
  sleepissue_score ~ total_active_min + sleep_score + stress_score + factor(education_abrv, ordered = FALSE) + race_category + bmi + age + lh + estrogen + (1 | id), data = merged_df_model, REML = FALSE)
...
sorebreasts_model = lmer( 
  sorebreasts_score ~ total_active_min + sleep_score + stress_score + factor(education_abrv, ordered = FALSE) + race_category + bmi + age + lh + estrogen + (1 | id), data = merged_df_model, REML = FALSE)
